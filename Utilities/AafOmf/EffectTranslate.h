...
// MC Private parameters
const aafUID_t AUID_PropertyMobAppCode = { 0x96c46992, 0x4f62, 0x11d3, { 0xa0, 0x22, 0x0, 0x60, 0x94, 0xeb, 0x75, 0xcb } };

//!!! Check the following codes to see if Andy has already generated GUIDs for them.
const aafUID_t AUID_PropertyOperationGroupMCEffect = { 0x584F2DD2, 0x96F5, 0x11d3, { 0x80, 0xE1, 0x00,0x60,0x08,0x14,0x3E,0x6F}};
const aafUID_t kAAFParamID_AvidSelected = { 0x386E92F8, 0x978E, 0x11d3, { 0x80, 0xE1, 0x00,0x60,0x08,0x14,0x3E,0x6F}};
