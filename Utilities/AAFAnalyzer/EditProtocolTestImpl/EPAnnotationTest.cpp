...
shared_ptr<TestLevelTestResult> EPAnnotationTest::Execute()
{
    ...
    shared_ptr<EPAnnotationVisitor> spVisitor(new EPAnnotationVisitor( GetOutStream(), GetTestGraph()->GetEdgeMap() ) );
    ...
    {
        spResult->SetExplanation(L"Test Failed - See \"Edit Protocol Annotation Visitor\" Visitor for details");
    }
