...
bool TypedVisitor::PostOrderVisit(boost::shared_ptr<AAFTypedObjNode<IAAFSelector> > spNode)
{ return true; }

bool TypedVisitor::PreOrderVisit(boost::shared_ptr<AAFTypedObjNode<IAAFSequence> > spNode)
{ return true; }
...
bool TypedVisitor::PostOrderVisit(boost::shared_ptr<AAFTypedObjNode<IAAFTimecodeStream> > spNode)
{ return true; }

bool TypedVisitor::PreOrderVisit(boost::shared_ptr<AAFTypedObjNode<IAAFTimecodeStream12M> > spNode)
{ return true; }
...
bool TypedVisitor::PostOrderVisit(boost::shared_ptr<AAFTypedObjNode<IAAFRecordingDescriptor> > spNode)
{ return true; }

bool TypedVisitor::PreOrderVisit(boost::shared_ptr<AAFTypedObjNode<IAAFAuxiliaryDescriptor> > spNode)
{ return true; }
...
bool TypedVisitor::EdgeVisit(boost::shared_ptr<AAFComponentReference> spEdge)
{ return true; }

bool TypedVisitor::EdgeVisit(boost::shared_ptr<AAFMobReference> spEdge)
{ return true; }

bool TypedVisitor::EdgeVisit(boost::shared_ptr<AAFSlotReference> spEdge)
{ return true; }
