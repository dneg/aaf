...
class TypedVisitor : public Visitor
{
  public:
    ...
    bool PreOrderVisit(boost::shared_ptr<AAFTypedObjNode<IAAFTypeDefEnum> > spNode);
    bool PostOrderVisit(boost::shared_ptr<AAFTypedObjNode<IAAFTypeDefEnum> > spNode);
    ...
    bool PreOrderVisit(boost::shared_ptr<AAFTypedObjNode<IAAFTypeDefExtEnum> > spNode);
    bool PostOrderVisit(boost::shared_ptr<AAFTypedObjNode<IAAFTypeDefExtEnum> > spNode);
