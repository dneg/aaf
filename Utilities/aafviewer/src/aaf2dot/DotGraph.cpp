...
//-----------------------------------------------------------------------------
void
DefaultNode::Write( ofstream &dotFile, InstanceMapperProfile &profile )
{
   dotFile << _name << " [ ";
...
//-----------------------------------------------------------------------------
void 
DefaultEdge::Write( ofstream &dotFile, InstanceMapperProfile &profile )
{
   dotFile << _name << " [ ";
...
//-----------------------------------------------------------------------------
void
DotGraph::Write( ofstream &dotFile, InstanceMapperProfile &profile )
{
