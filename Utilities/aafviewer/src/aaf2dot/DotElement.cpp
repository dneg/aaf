...
//-----------------------------------------------------------------------------
void 
DotElement::WriteElementAttributes( ofstream &dotFile, InstanceMapperProfile &profile )
{
...
//-----------------------------------------------------------------------------
void 
DotElement::WriteGlobalElementAttributes( ofstream &dotFile, InstanceMapperProfile &profile )
{
   DotElementAttributeMap::iterator iter;
   for ( iter=_attributes.begin(); iter!=_attributes.end(); iter++ )
   {
