...
//-----------------------------------------------------------------------------
void 
DotRecordNodeAttribute::Write( ofstream &dotFile, InstanceMapperProfile &profile )
{
...
//-----------------------------------------------------------------------------
int
DotRecordNodeAttribute::GetWidth( InstanceMapperProfile &profile )
{
   string ltdAttributeString = LimitAttributeSize( GetAttributeString(),
						   profile.GetMaxAttributeLength(), profile.GetMaxAttributeWidth() );
...
//-----------------------------------------------------------------------------
void 
DotRecordNode::Write( ofstream &dotFile, InstanceMapperProfile &profile )
{
