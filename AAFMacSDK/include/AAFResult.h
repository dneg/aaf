...
#define AAFRESULT_READ_FAILURE               MAKE_AAFHRESULT(0x0031)
...
#define AAFRESULT_NO_MORE_FLAVOURS		    MAKE_AAFHRESULT(0x00BA)
...
#define AAFRESULT_INVALID_SEARCH_CRIT       MAKE_AAFHRESULT(0x0113)
...
#define AAFRESULT_EVENT_SEMANTICS           MAKE_AAFHRESULT(0x012A)
...
#define AAFRESULT_FILEKIND_NOT_REGISTERED   MAKE_AAFHRESULT(0x0140)
