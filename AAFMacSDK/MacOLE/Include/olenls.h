...
#undef NORM_IGNOREWIDTH	    // different in win32 NLS
#define NORM_IGNOREWIDTH        0x00000008  /* ignore width */
#undef NORM_IGNOREKANATYPE  // different in win32 NLS
...
#undef LCMAP_HALFWIDTH	// different in win32 NLS
#define LCMAP_HALFWIDTH      0x00000800  /* narrow pitch case letters */
#undef LCMAP_FULLWIDTH	// different in win32 NLS
#define LCMAP_FULLWIDTH      0x00001000  /* wide picth case letters */ 
#undef LCMAP_HIRAGANA	// different in win32 NLS
#define LCMAP_HIRAGANA       0x00002000  /* map katakana to hiragana */
#undef LCMAP_KATAKANA	// different in win32 NLS
...
#define LOCALE_SSHORTDATE           0x0000001F    /* short date-time separator */
#define LOCALE_SLONGDATE            0x00000020    /* long date-time separator */
...
#define LOCALE_IPOSSEPBYSPACE       0x00000055    /* mon sym sep by space from pos */ 
#define LOCALE_INEGSYMPRECEDES      0x00000056    /* mon sym precedes neg amt */
#define LOCALE_INEGSEPBYSPACE       0x00000057    /* mon sym sep by space from neg */
