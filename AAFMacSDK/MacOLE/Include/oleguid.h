...
DEFINE_OLEGUID(IID_IMacDragHelper,	    0x0000013F, 0, 0);


// REVIEW: Are these guids used by win32 as well???
DEFINE_OLEGUID(IID_IOleInPlaceObjectMx,       0x0000012a, 0, 0);
DEFINE_OLEGUID(IID_IOleWindowMx,              0x0000012b, 0, 0);
DEFINE_OLEGUID(IID_IOleInPlaceUIWindowMx,     0x0000012c, 0, 0);
DEFINE_OLEGUID(IID_IOleInPlaceFrameMx,        0x0000012d, 0, 0);
DEFINE_OLEGUID(IID_IOleInPlaceActiveObjectMx, 0x0000012e, 0, 0);
DEFINE_OLEGUID(IID_IOleInPlaceSiteMx,         0x0000012f, 0, 0);
