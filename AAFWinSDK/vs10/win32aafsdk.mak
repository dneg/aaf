...
TOOLKIT_COMIDL = $(AAFTOOLKIT)\AAFWinSDK\$(VSVER)\ref-impl\include\comidl
TOOLKIT_DEBUG_REFIMPL = $(AAFTOOLKIT)\AAFWinSDK\$(VSVER)\Debug\RefImpl
TOOLKIT_RELEASE_REFIMPL = $(AAFTOOLKIT)\AAFWinSDK\$(VSVER)\Release\RefImpl
TOOLKIT_DEBUG_REFIMPL_EXT = $(AAFTOOLKIT)\AAFWinSDK\$(VSVER)\Debug\RefImpl\aafext
TOOLKIT_RELEASE_REFIMPL_EXT = $(AAFTOOLKIT)\AAFWinSDK\$(VSVER)\Release\RefImpl\aafext
