...
# ADD CPP /nologo /W3 /GX /O2 /I "..\..\..\OMF\include" /I "..\..\..\OMF\portinc" /I "../../../ref-impl/include" /I "../../../ref-impl/include/com-api" /I "../../../ref-impl/include/OM" /I "../../ref-impl/include/comidl" /I "../../../utilities/include" /I "../../../ref-impl/src/OM" /D "COM_NO_WINDOWS_H" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_UNICODE" /D "UNICODE" /YX /FD /c
...
# ADD LINK32 libbento.lib libjpeg.lib libomfi.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:yes /machine:I386 /libpath:"..\..\..\OMF" /libpath:"../Release/RefImpl"
