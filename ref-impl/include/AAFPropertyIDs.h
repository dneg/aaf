...
const int PID_AuxiliaryDescriptor_MimeType                       = 0x3A08;
const int PID_AuxiliaryDescriptor_CharSet                        = 0x3A08;
const int PID_TaggedValueDefinition_TaggedValueParentProperties  = 0x4C01;
const int PID_KLVDataDefinition_KLVDataParentProperties          = 0x4D01;
