...
const int PID_SourceReference_ChannelIDs                         = 0x1103;
const int PID_SourceReference_MonoSourceSlotIDs                  = 0x1104;
...
const int PID_FileDescriptor_LinkedSlotID                        = 0x3006;
...
const int PID_CDCIDescriptor_ReversedByteOrder                   = 0x330B;
...
const int PID_RGBADescriptor_ScanningDirection                   = 0x3405;
const int PID_RGBADescriptor_ComponentMaxRef                     = 0x3406;
const int PID_RGBADescriptor_ComponentMinRef                     = 0x3407;
const int PID_RGBADescriptor_AlphaMaxRef                         = 0x3408;
const int PID_RGBADescriptor_AlphaMinRef                         = 0x3409;
...
const int PID_EventMobSlot_EventSlotOrigin                       = 0x4902;
...
const int PID_SoundDescriptor_AudioSamplingRate                  = 0x3D03;
const int PID_SoundDescriptor_Locked                             = 0x3D02;
const int PID_SoundDescriptor_AudioRefLevel                      = 0x3D04;
const int PID_SoundDescriptor_ElectroSpatial                     = 0x3D05;
...
const int PID_PCMDescriptor_ChannelAssignment                    = 0x3D32;
const int PID_PCMDescriptor_PeakEnvelopeVersion                  = 0x3D29;
const int PID_PCMDescriptor_PeakEnvelopeFormat                   = 0x3D2A;
const int PID_PCMDescriptor_PointsPerPeakValue                   = 0x3D2B;
const int PID_PCMDescriptor_PeakEnvelopeBlockSize                = 0x3D2C;
const int PID_PCMDescriptor_PeakChannels                         = 0x3D2D;
const int PID_PCMDescriptor_PeakFrames                           = 0x3D2E;
...
const int PID_KLVDataDefinition_KLVDataType                      = 0x4D12;
const int PID_AuxiliaryDescriptor_MimeType                       = 0x4E11;
const int PID_AuxiliaryDescriptor_CharSet                        = 0x4E12;
...
const int PID_BWFImportDescriptor_QltyQualityEvent               = 0x3D24;
const int PID_BWFImportDescriptor_QltyEndOfModulation            = 0x3D25;
const int PID_BWFImportDescriptor_QltyQualityParameter           = 0x3D26;
