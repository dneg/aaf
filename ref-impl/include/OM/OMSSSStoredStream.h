...
// @doc OMINTERNAL
#ifndef OMSSSSTOREDSTREAM_H
#define OMSSSSTOREDSTREAM_H

#include "OMSSSStructuredStorage.h"
#include "OMStoredStream.h"

  // @class Implementation of <c OMStoredStream> for SchemaSoft Structured Storage.
  //   @base public | <c OMStoredStream>
  //   @cauthor Tim Bingham | tjb | Avid Technology, Inc.
class OMSSSStoredStream : public OMStoredStream {
public:
  // @access Public members.

    // @cmember Constructor.
  OMSSSStoredStream(Stream* stream);

    // @cmember Destructor.
  ~OMSSSStoredStream(void);
