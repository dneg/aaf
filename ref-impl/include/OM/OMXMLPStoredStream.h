...
// @doc OMINTERNAL
#ifndef OMXMLPSTOREDSTREAM_H
#define OMXMLPSTOREDSTREAM_H
...
class OMXMLPStoredStream : public OMStoredStream {
public:
  // @access Public members.

    // @cmember Constructor.
  OMXMLPStoredStream(OMRawStorage* store);

    // @cmember Destructor.
  ~OMXMLPStoredStream(void);
