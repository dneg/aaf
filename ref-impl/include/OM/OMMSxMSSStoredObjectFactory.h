...
class OMMSxMSSStoredObjectFactory : public OMMSSStoredObjectFactory {
public:
  // @access Public members.

    // @cmember Constructor.
  OMMSxMSSStoredObjectFactory(const OMStoredObjectEncoding& encoding,
                           const OMUniqueObjectIdentification& signature,
                           const wchar_t* name,
                           const wchar_t* description);

    // @cmember Destructor.
  virtual ~OMMSxMSSStoredObjectFactory(void);

    // @cmember Initialize this <c OMMSxMSSStoredObjectFactory>.
  virtual void initialize(void);

    // @cmember Finalize this <c OMMSxMSSStoredObjectFactory>.
