...
// @doc OMINTERNAL
#ifndef OMXMLPSTOREDOBJECTFACTORY_H
#define OMXMLPSTOREDOBJECTFACTORY_H
...
class OMRawStorage;
  ...
  // @class Factories for <c OMXMLPStoredObject>
  //   @cauthor Tim Bingham | tjb | Avid Technology, Inc.
class OMXMLPStoredObjectFactory : public OMStoredObjectFactory {
public:
  // @access Public members.

    // @cmember Constructor.
  OMXMLPStoredObjectFactory(const OMStoredObjectEncoding& encoding,
                           const OMUniqueObjectIdentification& signature,
                           const wchar_t* name,
                           const wchar_t* description);

    // @cmember Destructor.
  virtual ~OMXMLPStoredObjectFactory(void);

    // @cmember Initialize this <c OMXMLPStoredObjectFactory>.
  virtual void initialize(void);

    // @cmember Finalize this <c OMXMLPStoredObjectFactory>.
  ...
  virtual OMStoredObject* createModify(OMRawStorage* rawStorage,
    ...
    // @cmember Open the root <c OMXMLPStoredObject> in the disk file
  ...
  virtual OMStoredObject* openModify(const wchar_t* fileName);
    ...
    // @cmember Create a new root <c OMXMLPStoredObject> in the disk file
