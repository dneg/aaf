...
// @doc OMINTERNAL
#ifndef OMSSSSTOREDOBJECTFACTORY_H
#define OMSSSSTOREDOBJECTFACTORY_H
...
class OMRawStorage;
  ...
  // @class Factories for <c OMSSSStoredObject>
  //   @cauthor Tim Bingham | tjb | Avid Technology, Inc.
class OMSSSStoredObjectFactory : public OMStoredObjectFactory {
public:
  // @access Public members.

    // @cmember Constructor.
  OMSSSStoredObjectFactory(const OMStoredObjectEncoding& encoding,
                           const OMUniqueObjectIdentification& signature,
                           const wchar_t* name,
                           const wchar_t* description);

    // @cmember Destructor.
  virtual ~OMSSSStoredObjectFactory(void);

    // @cmember Initialize this <c OMSSSStoredObjectFactory>.
  virtual void initialize(void);

    // @cmember Finalize this <c OMSSSStoredObjectFactory>.
