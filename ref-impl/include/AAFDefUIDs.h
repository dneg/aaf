...
const aafUID_t NilCodecVariety = { 0x1B31F3B1, 9450, 0x11d2, { 0x80, 0x89, 0x00, 0x60, 0x08, 0x14, 0x3E, 0x6F } };
const aafUID_t CodecWave = { 0xCCE16660, 95E1, 0x11d2, { 0x89, 0xA5, 0x00, 0x60, 0x97, 0x11, 0x62, 0x12 } };
