...
// AAFMetaDict.csv 
//
// This file was generated on Tue Mar 21 09:41:37 EST 2006
...
AAF_CLASS(EssenceDescriptor,
  ...
  AAF_PROPERTY(SubDescriptors,
    // {6114-610-00-060E-2B340101019}
    // 06.0E.2B.34.01.01.01.9.6.1.1.4.6.10.0.0
...
AAF_CLASS(FileDescriptor,
  ...
  AAF_PROPERTY(LinkedSlotID,
    // {0601013-50-0000-060E-2B340101015}
    // 06.0E.2B.34.01.01.01.5.06.01.01.3.5.0.00.00
    AAF_LITERAL_AUID(0x0601013,
      0x50, 0x0000,
...
AAF_CLASS(EventMobSlot,
  ...
  AAF_PROPERTY(EventSlotOrigin,
    // {7213-10B-00-060E-2B340101015}
    // 06.0E.2B.34.01.01.01.5.7.2.1.3.1.0B.0.0
    AAF_LITERAL_AUID(0x7213,
      0x10B, 0x00,
      0x06, 0x0E, 0x2B, 0x34, 0x01, 0x01, 0x01, 0x5),
    0x4902,
    AAF_TYPE(PositionType),
...
AAF_CLASS(DataEssenceDescriptor,
  ...
  AAF_PROPERTY(DataEssenceCoding,
    // {043302-0000-0000-060E-2B340101013}
    // 06.0E.2B.34.01.01.01.3.04.3.3.02.00.00.00.00
    AAF_LITERAL_AUID(0x043302,
      0x0000, 0x0000,
      0x06, 0x0E, 0x2B, 0x34, 0x01, 0x01, 0x01, 0x3),
    0x3e01,
    AAF_TYPE(AUID),
    false,
    false,
...
AAF_CLASS(DescriptiveClip,
  ...
  AAF_PROPERTY(SourceTrackIDs,
    // {1716-000-0000-060E-2B340101015}
    // 06.0E.2B.34.01.01.01.5.1.7.1.6.0.00.00.00
    AAF_LITERAL_AUID(0x1716,
      0x000, 0x0000,
      0x06, 0x0E, 0x2B, 0x34, 0x01, 0x01, 0x01, 0x5),
    0x6103,
    AAF_TYPE(UInt32Set),
...
AAF_TYPE_DEFINITION_STRONG_REFERENCE(
  ...
  // {05022600-0000-0000-60E-2B340104011}
  // 6.0E.2B.34.01.04.01.1.05.02.26.00.00.00.00.00
  AAF_LITERAL_AUID(0x05022600,
    0x0000, 0x0000,
    0x6, 0x0E, 0x2B, 0x34, 0x01, 0x04, 0x01, 0x1),
