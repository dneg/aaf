...
const aafUID_t DDEF_Picture =  { 0x01030202, 0x0100, 0x0000, { 0x6, 0xe, 0x2b, 0x34, 0x4, 0x1, 0x1, 0x1 } };
...
const aafUID_t DDEF_Sound = { 0x01030202, 0x0200, 0x0000, { 0x6, 0xe, 0x2b, 0x34, 0x4, 0x1, 0x1, 0x1 } }; 
// const aafUID_t DDEF_Timecode_v1 = { 0x7F275E81, 0x77E5, 0x11D2, { 0x80, 0x7F, 0x00, 0x60, 0x08, 0x14, 0x3E, 0x6F } };
const aafUID_t DDEF_Timecode = { 0x01030201, 0x0100, 0x0000, { 0x6, 0xe, 0x2b, 0x34, 0x4, 0x1, 0x1, 0x1 } };
const aafUID_t DDEF_Edgecode = { 0xd2bb2af0, 0xd234, 0x11d2, { 0x89, 0xee, 0x0, 0x60, 0x97, 0x11, 0x62, 0x12 } };
const aafUID_t DDEF_DescriptiveMetadata = { 0x01030201, 0x1000, 0x0000, { 0x6, 0xe, 0x2b, 0x34, 0x4, 0x1, 0x1, 0x1 } };
const aafUID_t DDEF_Auxiliary = { 0x01030203, 0x0100, 0x0000, { 0x6, 0xe, 0x2b, 0x34, 0x4, 0x1, 0x1, 0x5 } };
