...
const IID IID_IAAFEssenceCodec3 = {0xF375A58F,0xEB6A,0x49C7,{0x90,0xA2,0x79,0x37,0x32,0x9A,0xE0,0xE4}};
...
const IID IID_IAAFEssenceDataStream2 = {0xF8C9C2A1,0xDD6B,0x4e10,{0x88,0x4F,0x01,0x2A,0xF4,0x35,0x50,0xBC}};
