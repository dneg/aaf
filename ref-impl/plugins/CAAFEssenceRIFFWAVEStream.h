...
#define __CAAFEssenceRIFFWAVEStream_h__
...
class CAAFEssenceRIFFWAVEStream
...
protected:
  ...
  //
  CAAFEssenceRIFFWAVEStream (CAAFEssenceRIFFWAVEContainer *pContainer,
                         CAAFEssenceRIFFWAVEStream *pPrevFileStream);
  virtual ~CAAFEssenceRIFFWAVEStream ();
...
public:
  ...
  //
  static CAAFEssenceRIFFWAVEStream *CreateFileStream(CAAFEssenceRIFFWAVEContainer *pContainer);
...
public :
  ...
  CAAFEssenceRIFFWAVEStream* PrevFileStream() const;
  void SetPrevFileStream(CAAFEssenceRIFFWAVEStream *pPrevFileStream);
  ...
  CAAFEssenceRIFFWAVEContainer *_pContainer;

  //
  // Previous file stream.
  CAAFEssenceRIFFWAVEStream *_pPrevFileStream;
...
#endif // ! __CAAFEssenceRIFFWAVEStream_h__
