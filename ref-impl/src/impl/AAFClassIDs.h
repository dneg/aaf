...
//=--------------------------------------------------------------------------=
//
#ifndef __AAFClassIDs_h__
#define __AAFClassIDs_h__
...
extern "C" const aafClassID_t CLSID_AAFHTMLClip;
extern "C" const aafClassID_t CLSID_AAFHTMLDescriptor;
...
extern "C" const aafClassID_t CLSID_AAFTextClip;
...
extern "C" const aafClassID_t CLSID_AAFBWFImportDescriptor;
...
extern "C" const aafClassID_t CLSID_AAFConstantValue;
...
extern "C" const aafClassID_t CLSID_AAFDataEssenceDescriptor;
extern "C" const aafClassID_t CLSID_AAFDefObject;
extern "C" const aafClassID_t CLSID_AAFDescriptiveClip;
extern "C" const aafClassID_t CLSID_AAFDescriptiveFramework;
extern "C" const aafClassID_t CLSID_AAFDescriptiveMarker;
extern "C" const aafClassID_t CLSID_AAFDescriptiveObject;
...
extern "C" const aafClassID_t CLSID_AAFEssenceGroup;
extern "C" const aafClassID_t CLSID_AAFEvent;
...
extern "C" const aafClassID_t CLSID_AAFMPEGVideoDescriptor;
...
extern "C" const aafClassID_t CLSID_AAFOperationDef;
extern "C" const aafClassID_t CLSID_AAFOperationGroup;
...
extern "C" const aafClassID_t CLSID_AAFRGBADescriptor;
...
extern "C" const aafClassID_t CLSID_AAFRIFFChunk;
...
extern "C" const aafClassID_t CLSID_AAFStaticMobSlot;
extern "C" const aafClassID_t CLSID_AAFSubDescriptor;
extern "C" const aafClassID_t CLSID_AAFTIFFDescriptor;
...
extern "C" const aafClassID_t CLSID_AAFTextLocator;
...
extern "C" const aafClassID_t CLSID_AAFTypeDefCharacter;
extern "C" const aafClassID_t CLSID_AAFTypeDefEnum;
extern "C" const aafClassID_t CLSID_AAFTypeDefExtEnum;
...
extern "C" const aafClassID_t CLSID_AAFTypeDefSet;
extern "C" const aafClassID_t CLSID_AAFTypeDefStream;
extern "C" const aafClassID_t CLSID_AAFTypeDefString;
extern "C" const aafClassID_t CLSID_AAFTypeDefStrongObjRef;
extern "C" const aafClassID_t CLSID_AAFTypeDefVariableArray;
extern "C" const aafClassID_t CLSID_AAFTypeDefWeakObjRef;
