...
class CEnumAAFSegments
  : public IEnumAAFSegments,
    public CAAFRoot
{
protected:
  ...
  //
  CEnumAAFSegments (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CEnumAAFSegments ();
