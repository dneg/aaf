//@doc
//@class    EnumAAFTaggedValueDefs | Implementation class for EnumAAFTaggedValueDefs
#ifndef __CEnumAAFTaggedValueDefs_h__
#define __CEnumAAFTaggedValueDefs_h__
...
class CEnumAAFTaggedValueDefs
  : public IEnumAAFTaggedValueDefs,
    public CAAFRoot
{
protected:
  ...
  //
  CEnumAAFTaggedValueDefs (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CEnumAAFTaggedValueDefs ();
...
#endif // ! __CEnumAAFTaggedValueDefs_h__
