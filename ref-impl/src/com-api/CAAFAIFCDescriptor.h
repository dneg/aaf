...
#define __CAAFAIFCDescriptor_h__
...
class CAAFAIFCDescriptor
  : public IAAFAIFCDescriptor,
...
protected:
  ...
  //
  CAAFAIFCDescriptor (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CAAFAIFCDescriptor ();
...
#endif // ! __CAAFAIFCDescriptor_h__
