//@doc
//@class    AAFMetaDefinition | Implementation class for AAFMetaDefinition
#ifndef __CAAFMetaDefinition_h__
#define __CAAFMetaDefinition_h__
...
class CAAFMetaDefinition
  : public IAAFMetaDefinition,
    public CAAFRoot
{
protected:
  ...
  //
  CAAFMetaDefinition (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CAAFMetaDefinition ();
...
#endif // ! __CAAFMetaDefinition_h__
