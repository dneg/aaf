...
class CEnumAAFDataDefs
  : public IEnumAAFDataDefs,
    public CAAFRoot
{
protected:
  ...
  //
  CEnumAAFDataDefs (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CEnumAAFDataDefs ();
