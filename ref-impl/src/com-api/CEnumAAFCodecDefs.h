...
#define __CEnumAAFCodecDefs_h__
...
class CEnumAAFCodecDefs
  : public IEnumAAFCodecDefs,
    public CAAFRoot
{
protected:
  ...
  //
  CEnumAAFCodecDefs (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CEnumAAFCodecDefs ();
