//@doc
//@class    EnumAAFParameters | Implementation class for EnumAAFParameters
#ifndef __CEnumAAFParameters_h__
#define __CEnumAAFParameters_h__
...
class CEnumAAFParameters
  : public IEnumAAFParameters,
    public CAAFRoot
{
protected:
  ...
  //
  CEnumAAFParameters (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CEnumAAFParameters ();
...
#endif // ! __CEnumAAFParameters_h__
