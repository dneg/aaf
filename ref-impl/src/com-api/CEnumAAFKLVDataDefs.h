//@doc
//@class    EnumAAFKLVDataDefs | Implementation class for EnumAAFKLVDataDefs
#ifndef __CEnumAAFKLVDataDefs_h__
#define __CEnumAAFKLVDataDefs_h__
...
class CEnumAAFKLVDataDefs
  : public IEnumAAFKLVDataDefs,
    public CAAFRoot
{
protected:
  ...
  //
  CEnumAAFKLVDataDefs (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CEnumAAFKLVDataDefs ();
...
#endif // ! __CEnumAAFKLVDataDefs_h__
