...
#ifndef __CEnumAAFIdentifications_h__
#define __CEnumAAFIdentifications_h__
...
class CEnumAAFIdentifications
  : public IEnumAAFIdentifications,
    public CAAFRoot
{
protected:
  ...
  //
  CEnumAAFIdentifications (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CEnumAAFIdentifications ();
...
#endif // ! __CEnumAAFIdentifications_h__
