...
#define __CEnumAAFInterpolationDefs_h__
...
class CEnumAAFInterpolationDefs
  : public IEnumAAFInterpolationDefs,
    public CAAFRoot
{
protected:
  ...
  //
  CEnumAAFInterpolationDefs (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CEnumAAFInterpolationDefs ();
...
#endif // ! __CEnumAAFInterpolationDefs_h__
