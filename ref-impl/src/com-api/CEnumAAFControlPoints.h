...
#define __CEnumAAFControlPoints_h__
...
class CEnumAAFControlPoints
  : public IEnumAAFControlPoints,
    public CAAFRoot
{
protected:
  ...
  //
  CEnumAAFControlPoints (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CEnumAAFControlPoints ();
...
#endif // ! __CEnumAAFControlPoints_h__
