...
HRESULT STDMETHODCALLTYPE
    CAAFDictionary::LookupKLVDataDef (aafUID_constref  defId,
...
HRESULT STDMETHODCALLTYPE
    CAAFDictionary::LookupTaggedValueDef (aafUID_constref  defId,
        IAAFTaggedValueDefinition ** ppDef)
{
  ...
  try
    {
      hr = ptr->LookupTaggedValueDef (defId,
    pinternalppDef);
    }
  catch (OMException& e)
    {
