...
#ifndef __CEnumAAFRIFFChunk_h__
#define __CEnumAAFRIFFChunk_h__
...
class CEnumAAFRIFFChunk
  : public IEnumAAFRIFFChunk,
    public CAAFRoot
{
protected:
  ...
  //
  CEnumAAFRIFFChunk (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CEnumAAFRIFFChunk ();
...
public:
  ...
  STDMETHOD (Clone) (
    // new enumeration 
    /*[out,retval]*/ IEnumAAFRIFFChunk ** ppEnum);
