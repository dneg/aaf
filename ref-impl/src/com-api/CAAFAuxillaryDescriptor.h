//@doc
//@class    AAFAuxillaryDescriptor | Implementation class for AAFAuxillaryDescriptor
#ifndef __CAAFAuxillaryDescriptor_h__
#define __CAAFAuxillaryDescriptor_h__
...
class CAAFAuxillaryDescriptor
  : public IAAFAuxillaryDescriptor,
...
protected:
  ...
  //
  CAAFAuxillaryDescriptor (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CAAFAuxillaryDescriptor ();
...
#endif // ! __CAAFAuxillaryDescriptor_h__
