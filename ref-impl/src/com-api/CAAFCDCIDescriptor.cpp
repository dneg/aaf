...
HRESULT STDMETHODCALLTYPE
    CAAFCDCIDescriptor::SetAlphaSamplingWidth (aafUInt32  alphaSamplingWidth)
{
  HRESULT hr;
  ...
  try
    {
      hr = ptr->SetAlphaSamplingWidth (alphaSamplingWidth);
    }
  catch (OMException& e)
    {
      // OMExceptions should be handled by the impl code. However, if an
...
HRESULT STDMETHODCALLTYPE
    CAAFCDCIDescriptor::GetAlphaSamplingWidth (aafUInt32 *  pAlphaSamplingWidth)
{
  HRESULT hr;
  ...
  try
    {
      hr = ptr->GetAlphaSamplingWidth (pAlphaSamplingWidth);
    }
  catch (OMException& e)
    {
      // OMExceptions should be handled by the impl code. However, if an
...
HRESULT STDMETHODCALLTYPE
    CAAFCDCIDescriptor::SetReversedByteOrder (aafBoolean_t  reversedByteOrder)
{
  HRESULT hr;
  ...
  try
    {
      hr = ptr->SetReversedByteOrder (reversedByteOrder);
    }
  catch (OMException& e)
    {
      // OMExceptions should be handled by the impl code. However, if an
...
HRESULT STDMETHODCALLTYPE
    CAAFCDCIDescriptor::GetReversedByteOrder (aafBoolean_t *  pReversedByteOrder)
{
  HRESULT hr;
  ...
  try
    {
      hr = ptr->GetReversedByteOrder (pReversedByteOrder);
    }
  catch (OMException& e)
    {
      // OMExceptions should be handled by the impl code. However, if an
    ...
    void **ppvObj)
{
    ...
    if (EQUAL_UID(riid,IID_IAAFCDCIDescriptor2)) 
    { 
        *ppvObj = (IAAFCDCIDescriptor2 *)this; 
        ((IUnknown *)*ppvObj)->AddRef();
        return S_OK;
    }
