...
#define __CEnumAAFTaggedValues_h__
...
class CEnumAAFTaggedValues
  : public IEnumAAFTaggedValues,
    public CAAFRoot
{
protected:
  ...
  //
  CEnumAAFTaggedValues (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CEnumAAFTaggedValues ();
...
#endif // ! __CEnumAAFTaggedValues_h__
