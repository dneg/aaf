...
HRESULT STDMETHODCALLTYPE
    CAAFPCMDescriptor::SetChannelAssignment (aafUID_constref  channelAssignment)
{
  HRESULT hr;
...
HRESULT STDMETHODCALLTYPE
    CAAFPCMDescriptor::GetChannelAssignment (aafUID_t *  pChannelAssignment)
{
  HRESULT hr;
