...
OMXMLWriterSimple::~OMXMLWriterSimple()
{
    ...
    size_t elementCount = _elementStack.count();
...
void
OMXMLWriterSimple::writeElementContent(const wchar_t* content, size_t length)
{
...
void
OMXMLWriterSimple::writeName(const wchar_t* data, size_t length)
{
...
void
OMXMLWriterSimple::writeElementData(const wchar_t* data, size_t length)
{
...
void
OMXMLWriterSimple::writeAttributeData(const wchar_t* data, size_t length)
{
...
void
OMXMLWriterSimple::writeCommentData(const wchar_t* data, size_t length)
{
...
void
OMXMLWriterSimple::writeProcInstrData(const wchar_t* data, size_t length)
{
...
void
OMXMLWriterSimple::write(const wchar_t* data, size_t length)
{
...
void
OMXMLWriterSimple::writeRaw(const OMByte* bytes, size_t size)
{
