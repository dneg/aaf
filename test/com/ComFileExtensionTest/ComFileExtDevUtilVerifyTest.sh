...
# introduce a dependency on each utility into check build.  It uses
# the files generated by ComFileExtensionTest and is considered an
# adjunct to that test that should be run manually.
#
