...
//
// This file was generated on Mon Oct 13 10:41:38 EDT 2003
...
MXF_DEFINE_PACK_KEY(OpenCompleteHeader,
  MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x02, 0x05, 0x01, 0x01,
...
MXF_DEFINE_PACK_KEY(ClosedHeader,
  MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x02, 0x05, 0x01, 0x01,
...
MXF_DEFINE_PACK_KEY(ClosedCompleteHeader,
  MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x02, 0x05, 0x01, 0x01,
...
MXF_DEFINE_PACK_KEY(OpenCompleteBodyPartition,
  MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x02, 0x05, 0x01, 0x01,
...
MXF_DEFINE_PACK_KEY(ClosedCompleteBodyPartition,
  MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x02, 0x05, 0x01, 0x01,
...
MXF_DEFINE_PACK_KEY(CompleteFooter,
  MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x02, 0x05, 0x01, 0x01,
...
//
MXF_CLASS(V10IndexTableSegment,
  // 06.0e.2b.34.02.53.01.01.0d.01.02.01.01.10.00.00
  MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01,
            0x0d, 0x01, 0x02, 0x01, 0x01, 0x10, 0x00, 0x00),
  InterchangeObject,
  true)
  MXF_PROPERTY(IndexEditRate,
    // 06.0e.2b.34.01.01.01.05.05.30.04.06.00.00.00.00
  ...
  MXF_PROPERTY(IndexStartPosition,
    // 06.0e.2b.34.01.01.01.05.07.02.01.03.01.0a.00.00
    MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x01, 0x01, 0x01, 0x05,
    ...
    false,
    V10IndexTableSegment)
  MXF_PROPERTY(IndexDuration,
    // 06.0e.2b.34.01.01.01.05.07.02.02.01.01.02.00.00
    MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x01, 0x01, 0x01, 0x05,
    ...
    false,
    V10IndexTableSegment)
  MXF_PROPERTY(EditUnitByteCount,
    // 06.0e.2b.34.01.01.01.04.04.06.02.01.00.00.00.00
  ...
  MXF_PROPERTY(BodySID,
    ...
    false,
    V10IndexTableSegment)
  MXF_PROPERTY(SliceCount,
    // 06.0e.2b.34.01.01.01.04.04.04.04.01.01.00.00.00
    MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x01, 0x01, 0x01, 0x04,
  ...
  MXF_PROPERTY(PosTableCount,
    ...
    false,
    V10IndexTableSegment)
  MXF_PROPERTY(V10DeltaEntryArray,
    // 06.0e.2b.34.01.01.01.05.04.04.04.01.06.00.00.00
    MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x01, 0x01, 0x01, 0x05,
    ...
    false,
    V10IndexTableSegment)
  MXF_PROPERTY(V10IndexEntryArray,
    // 06.0e.2b.34.01.01.01.05.04.04.04.02.05.00.00.00
    MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x01, 0x01, 0x01, 0x05,
    ...
    false,
    V10IndexTableSegment)
MXF_CLASS_END(V10IndexTableSegment,
  MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01,
            0x0d, 0x01, 0x02, 0x01, 0x01, 0x10, 0x00, 0x00),
  InterchangeObject,
  true)
...
MXF_CLASS(IndexTableSegment,
  ...
  MXF_PROPERTY(IndexEntryArray,
    ...
    false,
    IndexTableSegment)
MXF_CLASS_END(IndexTableSegment,
  MXF_LABEL(0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01,
            0x0d, 0x01, 0x02, 0x01, 0x01, 0x10, 0x01, 0x00),
  InterchangeObject,
  true)
...
MXF_CLASS(GenericPictureEssenceDescriptor,
  ...
  MXF_PROPERTY(Gamma,
    ...
    false,
    GenericPictureEssenceDescriptor)
  MXF_PROPERTY(ImageAlignmentFactor,
