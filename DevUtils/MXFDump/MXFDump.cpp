...
void printPropertyExtensions(mxfKey& k, mxfLength& len, mxfFile infile);

void printPropertyExtensions(mxfKey& /* k */,
                             mxfLength& len,
                             mxfFile infile)
{
  mxfLength remaining = len;
...
void printTypeExtensions(mxfKey& k, mxfLength& len, mxfFile infile);

void printTypeExtensions(mxfKey& /* k */,
                         mxfLength& len,
                         mxfFile infile)
{
  mxfLength remaining = len;
